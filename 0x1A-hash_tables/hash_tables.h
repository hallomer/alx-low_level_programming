 ...
 * @next: Pointer to the next node in the hash table array
 ...
 * @array: Array of pointers to nodes in the hash table
 * @shead: Pointer to the head of the linked list in the sorted order
 * @stail: Pointer to the tail of the linked list in the sorted order
*/
